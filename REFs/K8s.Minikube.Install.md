...
This option requires Docker; has __security issues__. ([MD](Kubernetes.minik_NONE_DRIVER.md "Kubernetes.minik_NONE_DRIVER.md") | [HTML](Kubernetes.minik_NONE_DRIVER.html "@ browser"))  
...
### Install VirtualBox ([MD](VirtualBox.Install.html "@ browser"))
- This does __not__ work if Linux is on VM @ Hyper-V ([MD](Hyper-V.Nested-Virtualization.html "If @ browser")) .
...
## Kubernetes (`kubectl`) @ WSL [MD](file:///D:/1%20Data/IT/OS/Windows/Win10/WSL/WSL.md "See WSL.md") | [HTML](file:///D:/1%20Data/IT/OS/Windows/Win10/WSL/WSL.html "If @ browser")

- Problematic integration.

## Hello Minikube :: Quickstart  [MD](file:///D:/1%20Data/IT/Container/Kubernetes/Kubernetes.QuickStart.md "See Kubernetes.QuickStart.md") | [HTML](file:///D:/1%20Data/IT/Container/Kubernetes/Kubernetes.QuickStart.html "If @ browser")
