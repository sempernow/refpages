// Mod of https://learnxinyminutes.com/docs/go/ 
// 
// Single line comment
/* Multi-
 line comment */
...
func learnMemory() (p, q *int) {
    ...
    p = new(int) // Allocate memory; initialized to 0; `p` is no longer nil.
    s := make([]int, 20) // Allocate 20 ints as a single block of memory.
    s[3] = 7             // Assign one of them.
    r := -2              // Declare another local variable.
    b := [256]byte       // Declare var allocating 256 bytes; its type includes size
    // Access per b[0], b[1], ... b[255]
