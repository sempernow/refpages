...
- Install Minikube ( [MD](file:///D:/1%20Data/IT/Container/Kubernetes/REF.Minikube.Install.md "REF.Minikube.Install.md")  |  [HTML](file:///D:/1%20Data/IT/Container/Kubernetes/REF.Minikube.Install.html "If @ browser")) for Development (single-node cluster)
...
- Minikube supports a __`none` driver option__  that runs the Kubernetes components ___on the host and not in a VM___. Using this driver __requires Docker__, but __not a hypervisor__. The option has __security issues__. ([MD](REF.Kubernetes.minik_NONE_DRIVER.md "REF.Kubernetes.minik_NONE_DRIVER.md") | [HTML](REF.Kubernetes.minik_NONE_DRIVER.html "@ browser"))   
