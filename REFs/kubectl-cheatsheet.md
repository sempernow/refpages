...
# [`kubectl` Cheatsheet](https://github.com/kubernetes/website/tree/main/content/en/docs/reference/kubectl "GitHub") | [@ Kubernetes.io](https://kubernetes.io/docs/reference/kubectl/cheatsheet/)
...
```
- Requires Bash setting: '`set +o posix`'

Completion for alias of `kubectl` too:
